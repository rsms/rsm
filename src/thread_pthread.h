...
// I place this piece of code in the public domain. Feel free to use as you see fit.
// I'd appreciate it if you keep my name at the top of the code somehwere, but whatever.
